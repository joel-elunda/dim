...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        <meta charset="utf-8">
        <title>DIM BUSINESS - Admin</title>
        ...
        <!-- Syntax Highlighter -->
        <link rel="stylesheet" type="text/css" href="<?=base_url('assets/admin/syntax-highlighter/styles/shCore.css');?>" media="all">
        <link rel="stylesheet" type="text/css" href="<?=base_url('assets/admin/syntax-highlighter/styles/shThemeDefault.css');?>" media="all">
		
		<!-- Font Awesome CSS-->
        <link rel="stylesheet" href="<?=base_url('assets/admin/css/font-awesome.min.css');?>">
        <!-- Normalize/Reset CSS-->
		<link rel="stylesheet" href="<?=base_url('assets/admin/css/normalize.min.css');?>">
		<!-- Main CSS-->
    ...
    <body id="welcome">
        ...
        <aside class="left-sidebar">
            ...
            <nav class="left-nav">
                <ul id="nav"> 
                    <li class="current"><a href="#welcome"> <strong>ACCUEIL</strong> </a></li>
                    <li><a href="#installation"> <strong>Réalisations</strong> </a></li>
                    <li><a href="#tmpl-structure"> <strong>Déconnexion</strong> </a></li> 
                </ul>
            </nav>
        </aside>
		...
		==============================================-->
        <script type="text/javascript" src="<?=base_url('assets/admin/js/jquery-1.11.0.min.js');?>"></script>
        <script type="text/javascript" src="<?=base_url('assets/admin/js/jquery.nav.js');?>"></script>
        <script type="text/javascript" src="<?=base_url('assets/admin/syntax-highlighter/scripts/shCore.js');?>"></script> 
        <script type="text/javascript" src="<?=base_url('assets/admin/syntax-highlighter/scripts/shBrushXml.js');?>"></script> 
        <script type="text/javascript" src="<?=base_url('assets/admin/syntax-highlighter/scripts/shBrushCss.');?>"></script> 
        <script type="text/javascript" src="<?=base_url('assets/admin/syntax-highlighter/scripts/shBrushJScript.js');?>"></script> 
        <script type="text/javascript" src="<?=base_url('assets/admin/syntax-highlighter/scripts/shBrushPhp.js');?>"></script> 
