    	...
    	<div class="container">
			...
			<div class="row justify-content-center pb-5 mb-3">
				<div class="col-md-7 heading-section text-center ftco-animate">
					...
					<h2>Notre Business Solutions</h2>
				</div>
			</div>
          ...
          <div class="col-md-6 col-lg-3 d-flex services align-self-stretch px-4 ftco-animate">
            <div class="d-block">
              ...
              <div class="media-body">
                ...
                <p>Agro-DIM projet d'incubation du secteur agricol accompagnant les acteurs du domaine dans la création des chainesd de valeur.</p>
              </div>
            </div>    
          </div>
