    		...
    		<div class="row d-flex no-gutters">
    			...
    			<div class="col-md-6 pl-md-5 py-md-5">
    				<div class="heading-section pl-md-4 pt-md-5">
    					<span class="subheading">Bienvenu chez DIM BUSINESS</span>
	            <h2 class="mb-4">Nous sommes une pépinière de futurs créateurs d’entreprises</h2>
    				</div>
    				<div class="services-2 w-100 d-flex">
    					<div class="icon d-flex align-items-center justify-content-center"><span class="flaticon-wealth"></span></div>
    					<div class="text pl-4">
    						<h4>MEDIA</h4>
    						<p>Promotion du potentiel de créativité de l'écosystem entrepreneurial congolais jusqu'à l'étranger</p>
    					</div>
    				</div>
    				<div class="services-2 w-100 d-flex">
    					<div class="icon d-flex align-items-center justify-content-center"><span class="flaticon-accountant"></span></div>
    					<div class="text pl-4">
    						<h4>CABINET D'ETUDE DES PROJETS</h4>
    						<p>Agro-DIM projet d'incubation du secteur agricol accompagnant les acteurs du domaine dans la création des chainesd de valeurs</p>
    					</div>
    				</div>
    				<div class="services-2 w-100 d-flex">
    					...
    					<div class="text pl-4">
    						<h4>NUMERISATION ET TRANSFORMATION</h4>
    						<p>Etude et réalisation des numériques, technologiques et autres domaines grâce aux start-ups et partenaires affilié à notre plateforme</p>
    					</div>
    				</div>
    				<div class="services-2 w-100 d-flex">
    					<div class="icon d-flex align-items-center justify-content-center"><span class="flaticon-accounting"></span></div>
    					<div class="text pl-4">
    						<h4>CROWD FOUNDING</h4>
    						<p>Financement participatif des projets innovants et des actions bénévoles grâce à notre holding numérisé</p>
    					</div>
    				</div>
    				<div class="services-2 w-100 d-flex">
    					...
    					<div class="text pl-4">
    						<h4>SUCCESS FULL</h4>
    						<p>Centre de développement et de révolution des idées business et d'accompagnement en coaching et formation professionnelle</p>
    					</div>
    				</div>
	        </div>
        </div>
